...
cmd({
  ...
  try {
    ...
    if (!mediaUrl) {
      return message.reply("*_Failed To Create Url bro!_*");
    }
...
cmd({
  ...
  try {
    ...
    await message.send(util.format(mediaUrl.url), {}, "asta", mediaMessage);
  } catch (error) {
